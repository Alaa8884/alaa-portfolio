...
function BackGround() {
  return (
    <div className="--main-background pointer-events-none fixed left-0 top-0 z-10 flex h-full w-full items-center justify-center overflow-hidden opacity-70 blur-[100px] filter">
      ...
      ></motion.div>
      <motion.div
        className="absolute h-[260px] w-[360px] rounded-full bg-indigo-300"
        variants={circleVariants}
        animate="animate02"
      ></motion.div>
      <motion.div
      ...
      ></motion.div>
      <motion.div
        className="absolute h-[280px] w-[380px] rounded-full bg-purple-400"
        variants={circleVariants}
        animate="animate04"
      ></motion.div>
      <motion.div
        className="absolute h-[290px] w-[390px] rounded-full bg-purple-400"
        variants={circleVariants}
        animate="animate05"
      ></motion.div>
      <motion.div
        className="absolute h-[300px] w-[400px] rounded-full bg-purple-400"
        variants={circleVariants}
        animate="animate06"
      ></motion.div>
    </div>
